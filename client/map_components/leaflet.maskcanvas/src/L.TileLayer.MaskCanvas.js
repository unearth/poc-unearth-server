L.TileLayer.MaskCanvas = L.TileLayer.Canvas.extend({
    ...
    _drawPoints: function (ctx, coordinates) {
        ...
        coordinates.forEach(function(coords) {
            ...
            //     y = p[1],
            //     radius = 10,
            //     width = self._getRadius(),
            //     height = self._getRadius();

            // g.moveTo(x,y+radius);
            // g.lineTo(x,y+height-radius);
            // g.quadraticCurveTo(x,y+height,x+radius,y+height);
            // g.lineTo(x+width-radius,y+height);
            // g.quadraticCurveTo(x+width,y+height,x+width,y+height-radius);
            // g.lineTo(x+width,y+radius);
            // g.quadraticCurveTo(x+width,y,x+width-radius,y);
            // g.lineTo(x+radius,y);
            // g.quadraticCurveTo(x,y,x,y+radius);
